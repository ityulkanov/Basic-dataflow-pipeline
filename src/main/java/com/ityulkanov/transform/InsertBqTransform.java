 ...
 */
@Slf4j
public class InsertBqTransform extends PTransform<PCollectionTuple, WriteResult> {
    ...
    public InsertBqTransform(TupleTag<String> tag, TupleTag<TableRow> transformOut, TupleTag<ErrorTblDtl> transformFail,
